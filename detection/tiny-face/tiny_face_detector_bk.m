...
function bboxes = tiny_face_detector(image, output_path, prob_thresh, nms_thresh, gpu_id, display_image, tiny_face_path, model_path)
...
% load input
t1 = tic;
% checks if image is an image path or a loaded image
if ischar( image )
